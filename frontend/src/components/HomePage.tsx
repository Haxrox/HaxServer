...
// Fluent UI
import { Card, Image, tokens, Toolbar, ToolbarButton } from '@fluentui/react-components';
...
export default function Home() {
  ...
  const shanchi = useTranslations('ShanChi');
    ...
    <>
      ...
      <main style={{
        ...
        <Card style={{
          ...
          height: '75%', // Fixed height to ensure proper centering
        }}>
          ...
          {/* <Link href="/test" appearance='primary'>
            Test
          </Link> */}
        </Card>
      </main>
